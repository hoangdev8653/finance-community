...
export const metadata: Metadata = buildPageMetadata({
  ...
  description:
    'Tra cứu toàn bộ thẻ chủ đề tài chính, mã chứng khoán và từ khóa thị trường được phân loại trên BrewSeven.',
  canonicalPath: '/the',
});
...
export default function TagsPage() {
  const collectionSchema = generateCollectionPageJsonLd(
    ...
    'Danh mục thẻ phân loại thị trường, nhóm tài sản và chủ đề tài chính trên BrewSeven.',
    '/the'
  );

  const breadcrumbsSchema = generateBreadcrumbsJsonLd([
    { name: 'Trang chủ', url: '/' },
    { name: 'Thẻ Chủ Đề', url: '/the' },
  ]);
