...
const nextConfig: NextConfig = {
  async redirects() {
    const routes = {
      ...
      '/profile': '/ho-so', '/search': '/tim-kiem', '/series': '/chuoi-bai', '/tags': '/the',
      '/terms': '/dieu-khoan', '/tools': '/cong-cu', '/admin': '/quan-tri',
      '/learning/explore': '/chuoi-bai', '/hoc-tap/kham-pha': '/chuoi-bai',
    ...
    return [
      ...
      { source: '/series/:path*', destination: '/chuoi-bai/:path*', permanent: true },
